      ...
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action={{route('dentist.diagnosa')}} class="" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                            @if (session('status'))
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                              <div class="form-group">
                                  ...
                                  <input type="text" name="kode" id="kode" class="form-control" value="{{ old('kode') ?? '' }}" placeholder="--kode diagnosa--">
                                  @error('kode')
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" name="diagnosa" id="diagnosa" class="form-control" value="{{ old('diagnosa') ?? '' }}" placeholder="--diagnosa--">
                                  @error('diagnosa')
