      ...
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action={{route('dentist.treatment.edit', ['id' => $treatment->id])}} class="" method="post">
                        @csrf
                        @method('patch')
                        <div class="row">
                            <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tindakan" id="tindakan" class="form-control" value="{{ old('tindakan') ?? $treatment->tindakan}}" placeholder="--tindakan--">
                                @error('tindakan')
