      ...
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action={{route('dentist.school.edit', ['id'=>$school->id])}} class="" method="post">
                        @csrf
                        @method('patch')
                        <div class="row">
                            <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                              <div class="form-group">
                                  ...
                                  <input type="text" name="sekolah" id="sekolah" class="form-control" value="{{ old('sekolah') ?? $school->sekolah }}" placeholder="--nama sekolah--">
                                  @error('sekolah')
