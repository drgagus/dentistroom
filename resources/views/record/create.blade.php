      ...
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" action={{route('dentist.create')}} method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="tanggalkunjungan" id="tanggalkunjungan" placeholder="--tanggal kunjungan--" value="{{old('tanggalkunjungan') ?? '' }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="norm" id="norm" placeholder="--nomor rekam medik--" value="{{old('norm') ?? ''}}">
                                    @error('norm')
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="village_id" name="village_id">
                                        ...
                                        <option {{ old('village_id')  == $village->id ? 'selected' : '' }} value={{$village->id}}>{{$village->desa}}</option>
                                        @endforeach
                                    </select>
                                    @error('village_id')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="school_id" name="school_id">
                                        ...
                                        <option {{ old('school_id')  == $school->id ? 'selected':'' }} value={{$school->id}}>{{$school->sekolah}}</option>
                                        @endforeach
                                    </select>
                                    @error('school_id')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="diag_id" name="diag_id">
                                        ...
                                        <option {{ old('diag_id')  == $diag->id ? 'selected':'' }} value={{$diag->id}}>{{$diag->kode}} {{$diag->diagnosa}}</option>
                                        @endforeach
                                    </select>
                                    @error('diag_id')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="treatment_id" name="treatment_id">
                                        ...
                                        <option {{ old('treatment_id')  == $treatment->id ? 'selected':'' }} value={{$treatment->id}}>{{$treatment->tindakan}}</option>
                                        @endforeach
                                    </select>
                                    @error('treatment_id')
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" type="text" name="obat" id="obat" rows="3">{{ old('obat') ?? ''}}</textarea>
                                    @error('obat')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" type="text" name="catatan" id="catatan" rows="3">{{ old('catatan') ?? ''}}</textarea>
                                    @error('catatan')
